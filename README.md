...
Compte rendu du TP – Reverse shell sur l’ENT Ingetis
Introduction
...
La commande cat a à nouveau affiché le contenu du CSV, confirmant le format et la présence de la ligne de “JOBLON Keran;9.18”.
...
La note restait à 9.18. D’autres variantes n’ont pas fonctionné :
...
Après ls et cat, certains fichiers attendus n’apparaissaient pas ou n’étaient pas modifiés, ce qui montre que, dans certains contextes (via le champ commande web), les redirections peuvent être filtrées ou bloquées.
...
curl -I http://172.16.1.45:7552/login                    # curl absent avant installation
